...
using Chat.Core.HttpHelper.Enum;
using Chat.Core.HttpHelper.Item;
using Chat.Core.HttpHelper.Static;
...
namespace Chat.Core.HttpHelper.Helper
{
    ...
    internal class HtmlHelper
    {
        ...
        {
            var rx = string.Format("{0}{1}{2}", s, RegexString.AllHtml, e);
            if (Regex.IsMatch(html, rx, RegexOptions.IgnoreCase))
            {
                var match = Regex.Match(html, rx, RegexOptions.IgnoreCase);
